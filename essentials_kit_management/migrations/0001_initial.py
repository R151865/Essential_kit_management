# Generated by Django 3.0.5 on 2020-05-29 21:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100)),
                ('status', models.CharField(choices=[('LIVE', 'LIVE'), ('CLOSED', 'CLOSED'), ('DONE', 'DONE')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100)),
                ('description', models.TextField()),
                ('items', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='essentials_kit_management.Item')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
